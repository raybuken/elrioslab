        ...
        <div className='my-4'>
            <div className='row'>
                <div className="col-lg-4 col-md-6 my-1">
                    ...
                    <label className='display-6 ms-3'> {result.ed || 0} ED</label>
                </div>
                <div className="col-lg-4 col-md-6 my-1">
                    ...
                    <label className='display-6 ms-3'> x{result.glaciems || 0}</label>
                </div>
                <div className="col-lg-4 col-md-6 my-1">
