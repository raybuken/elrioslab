...
export default function Section() {
    return (
        <div className="row justify-content-center text-center">
            ...
            <Tool link='/tools/el-search-party-collection' name='Collection &amp; sinergy' src={'/v1649022227/files/el-search-party-collection.png'} alt='El search party collection'/>
        </div>
    )
}